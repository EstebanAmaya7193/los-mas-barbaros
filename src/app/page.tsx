      ...
      <main className="flex-grow flex flex-col relative">
        ...
        <div className="relative z-20 -mt-8 px-8 md:px-6 pb-12 flex flex-col gap-12">
            ...
            <div className="flex justify-center items-center gap-6">
              ...
              <a className="text-gray-400 hover:text-black dark:hover:text-white transition-colors flex items-center justify-center" href="https://instagram.com/los_mas_barbaros_ibague" target="_blank" rel="noopener noreferrer">
                <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
